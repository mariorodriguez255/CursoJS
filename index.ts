// Definición de una interfaz para el estudiante
interface IEstudiante {
  ...
  class Estudiante implements IEstudiante {
    ...
    actualizarPromedio(nuevasCalificaciones: { materia: string, calificacion: number }[]): void {
      if (nuevasCalificaciones.length === 0) return;
  ...
  const estudiante1 = new Estudiante(
    ...
    3,
    ["Programación", "Matemáticas", "Física"]
  );
